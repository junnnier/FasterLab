...
class Adan(Optimizer):
    ...
    Adan: Adaptive Nesterov Momentum Algorithm for
        Faster Optimizing Deep Models[J].arXiv preprint arXiv:2208.06677, 2022. https://arxiv.org/abs/2208.06677
    Arguments:
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            if group['foreach']:
                ...
                self._single_tensor_adan(**kwargs)

        return loss

    def _single_tensor_adan(slef,
        params: List[Tensor],
        grads: List[Tensor],
