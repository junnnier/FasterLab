...
class SeperableConv2d(nn.Module):
    ...
    with one spatial convolution per output channel of the 1x1 convolution."""
...
class Xception(nn.Module):
    ...
    def __init__(self, block, num_class=100, activation=None):
        super().__init__()
...
def create_model(param):
    ...
    return Xception(MiddleFLowBlock, class_num, activation=activations)
