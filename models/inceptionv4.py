...
class Inception_Stem(nn.Module):
    ...
    """The schema for stem of the pure Inception-v4 and Inception-ResNet-v2 networks.
    This is the input part of those networks."""
...
class InceptionA(nn.Module):
    ...
    """The schema for 35 × 35 grid modules of the pure Inception-v4 network.
...
class ReductionA(nn.Module):
    ...
    Different variants of this blocks (with various number of filters) are used in Figure 9,
    and 15 in each of the new Inception(-v4, - ResNet-v1, -ResNet-v2) variants presented in this paper.
...
class InceptionC(nn.Module):
    ...
    def __init__(self, input_channels):
        """Figure 6. The schema for 8×8 grid modules of the pure Inceptionv4 network.
...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384, class_nums=100, activation=None):
...
class InceptionResNetB(nn.Module):
    ...
    def forward(self, x):
        ...
        """In general we picked some scaling factors between 0.1 and 0.3 to scale the residuals before their being added to the accumulated layer activations (cf. Figure 20)."""
...
class InceptionResNetReductionB(nn.Module):
    ...
    Reduction-B module used by the wider Inception-ResNet-v1 network in Figure 15."""
...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, A, B, C, k=256, l=256, m=384, n=384, class_nums=100, activation=None):
        super().__init__()
        self.stem = Inception_Stem(3)
...
def create_model(param):
    ...
    return InceptionV4(4, 7, 3, class_nums=class_num, activation=activations)
